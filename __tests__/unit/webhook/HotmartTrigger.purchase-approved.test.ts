...
describe('HotmartTrigger - PURCHASE_APPROVED', () => {
  let trigger: HotmartTrigger;
  let triggerFunctions: ITriggerFunctions;
  const fixturesDir = path.join(__dirname, '../../fixtures/webhook-fixtures-anon/purchase-approved');
  ...
  describe('PURCHASE_APPROVED Event Processing', () => {
    ...
    test('should handle PURCHASE_APPROVED in "all-events" mode', async () => {
      const webhookData = {
  ...
  describe('PURCHASE_APPROVED Data Validation', () => {
    test('should validate required fields', () => {
      ...
      expect(sampleFixture.event).toBe('PURCHASE_APPROVED');
    });
