...
describe('HotmartTrigger - PURCHASE_COMPLETE', () => {
  let trigger: HotmartTrigger;
  let triggerFunctions: ITriggerFunctions;
  const fixturesDir = path.join(__dirname, '../../fixtures/webhook-fixtures-anon/purchase-complete');
  ...
  describe('PURCHASE_COMPLETE Event Processing', () => {
    ...
    test('should handle PURCHASE_COMPLETE in "all-events" mode', async () => {
      const webhookData = {
  ...
  describe('PURCHASE_COMPLETE Data Validation', () => {
    test('should validate required fields', () => {
      ...
      expect(sampleFixture.event).toBe('PURCHASE_COMPLETE');
    });
