...
export type CouponOperationType = 'getAll';

export type ProductOperationType = 'getAll';

export type ClubOperationType = 'getAll';

export type TicketOperationType = 'getAll';
